    ...
    const handleClick = async () => {
        ...
        if ("manufacturer" in nfts.ownedNfts[i].rawMetadata) {
            ...
            timeCreated: nfts.ownedNfts[i].timeLastUpdated,
            });
        } else {
    ...
    const RedeemWarranty = (props: any) => {
        ...
        if (querySnapshot.docs.length != 0) {
            ...
            redeemTime: arrayUnion(date.toString()),
            pending: true,
            });
        } else {
        ...
        async function updateData() {
            ...
            setisPending(doc.data()["approval"]);
            });
        }
        }
        ...
        <div>
            ...
            <div className="hidden lg:flex lg:min-w-0 lg:flex-1 lg:justify-end bottom-0">
                ...
                <div className="flex items-center">
                    <a href="/User" className="">Browse</a>
                </div>
                <div className="flex items-center">
                    {" "}
                    <Wallet />{" "}
