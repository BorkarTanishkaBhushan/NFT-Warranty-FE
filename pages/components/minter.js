...
const Minter = (props) => {
  ...
  const mintNFT = async (name, description, price, period, manufacturer, url) => {
  ...
  >
    {image ? (
      <img src={URL.createObjectURL(image)} className="bg-gray-100 h-40 flex justify-center items-center rounded-md overflow-hidden" alt="Preview" />
    ) : (
